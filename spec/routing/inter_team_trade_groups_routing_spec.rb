...
RSpec.describe InterTeamTradeGroupsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #new" do
      expect(:get => "/inter_team_trade_groups/new").to route_to("inter_team_trade_groups#new")
    end
    ...
    it "routes to #edit" do
      expect(:get => "/inter_team_trade_groups/1/edit").to route_to("inter_team_trade_groups#edit", :id => "1")
    end
